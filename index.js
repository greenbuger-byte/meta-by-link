    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    var head, body_1, body_1_1, chunk, e_1_1;
                    var e_1, _a;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                head = '';
                                if (!Array.isArray(body)) return [3 /*break*/, 13];
                                _b.label = 1;
                            case 1:
                                _b.trys.push([1, 6, 7, 12]);
                                body_1 = __asyncValues(body);
                                _b.label = 2;
                            case 2: return [4 /*yield*/, body_1.next()];
                            case 3:
                                if (!(body_1_1 = _b.sent(), !body_1_1.done)) return [3 /*break*/, 5];
                                chunk = body_1_1.value;
                                head += chunk.toString();
                                if (head.toString().split('</head>')[1] != undefined) {
                                    head += "".concat(head.toString().split('</head>')[0], "</head></html>");
                                    resolve(head);
                                }
                                _b.label = 4;
                            ...
                            case 7:
                                ...
                                if (!(body_1_1 && !body_1_1.done && (_a = body_1["return"]))) return [3 /*break*/, 9];
